...
def write_audit_report(
    ...
    lines = [
        ...
        f"- clean_data_row_count: `{summary.clean_data_row_count}`",
        f"- review_queue_row_count: `{summary.review_queue_row_count}`",
        f"- internal_clean_candidate_count: `{summary.internal_clean_candidate_count}`",
        f"- internal_reference_candidate_count: `{summary.internal_reference_candidate_count}`",
        f"- narrative_review_count: `{summary.narrative_review_count}`",
        f"- review_required_count: `{summary.review_required_count}`",
        f"- excluded_from_clean_data_count: `{summary.excluded_from_clean_data_count}`",
        "",
        "## Boundary",
        "",
        ...
        "- Internal clean-data candidates do not imply client readiness or production readiness.",
        "",
        "## Sample Issues",
        "",
    ]
