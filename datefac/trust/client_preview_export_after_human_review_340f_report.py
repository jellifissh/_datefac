...
def report_markdown(summary: Dict[str, Any], qa_json: Dict[str, Any]) -> str:
    lines = [
        "# Client Preview After Human Review 340F",
        "",
        "340F creates a human-reviewed client preview from the 340E sidecar result.",
        "It does not write back to upstream workbooks and it is not production-ready.",
        "",
        "## Decision",
        ...
        "",
        "## Counts",
        f"- total_340e_input_rows: {summary.get('total_340e_input_rows', 0)}",
        f"- client_preview_core_metric_count: {summary.get('client_preview_core_metric_count', 0)}",
        f"- client_preview_confirmed_count: {summary.get('client_preview_confirmed_count', 0)}",
        f"- client_preview_corrected_count: {summary.get('client_preview_corrected_count', 0)}",
        ...
        f"- source_trace_count: {summary.get('source_trace_count', 0)}",
        "",
        "## Safety",
