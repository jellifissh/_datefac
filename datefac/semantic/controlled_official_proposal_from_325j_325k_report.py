...
def controlled_official_proposal_from_325j_markdown(summary: Dict[str, Any]) -> str:
    lines = [
        "# Controlled Official Proposal From 325J 325K",
        "",
        "## Decision",
        ...
        "",
        "## Notes",
        "- 325K creates controlled official proposals only.",
        "- 325K does not run dry run or apply official patches.",
        "- Official mapping and override assets remain read only in this stage.",
        "",
    ]
