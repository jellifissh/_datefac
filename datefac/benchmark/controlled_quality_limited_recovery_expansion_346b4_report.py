...
def render_executive_summary_markdown(
    ...
    *,
    ...
    return "\n".join(
        [
            "# 346B4 Executive Summary",
            "",
            "- 346B4 follows 346B2R and expands the 346B3 refined semantic unit policy to a controlled subset of 345D quality-limited rows.",
...
def render_next_plan_markdown(manifest: Dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            "- 346B5 must wait for an independent 346B4R QA audit before any larger recovery expansion.",
