...
from datefac.benchmark.core_metric_candidate_quality_342e_report import (  # noqa: E402
    WORKBOOK_SHEETS,
    report_markdown,
    write_excel,
    write_json,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run 342E core metric candidate quality audit.")
    ...
    summary_json = output_dir / "core_metric_candidate_quality_342e_summary.json"
    manifest_json = output_dir / "core_metric_candidate_quality_342e_manifest.json"
    qa_json = output_dir / "core_metric_candidate_quality_342e_qa.json"
    no_write_back_json = output_dir / "core_metric_candidate_quality_342e_no_write_back_proof.json"
    report_md = output_dir / "core_metric_candidate_quality_342e_report.md"
    workbook_xlsx = output_dir / "core_metric_candidate_quality_342e.xlsx"
    ...
    print(f"core_metric_candidate_quality_342e_summary_json: {summary_json}")
    print(f"core_metric_candidate_quality_342e_manifest_json: {manifest_json}")
    print(f"core_metric_candidate_quality_342e_qa_json: {qa_json}")
    print(f"core_metric_candidate_quality_342e_no_write_back_proof_json: {no_write_back_json}")
    print(f"core_metric_candidate_quality_342e_report_md: {report_md}")
    print(f"core_metric_candidate_quality_342e_xlsx: {workbook_xlsx}")
    for key in [
        "audited_pdf_count",
