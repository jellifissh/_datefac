...
from datefac.benchmark.table_first_extraction_review_package_342g import (  # noqa: E402
    ...
    DEFAULT_CORE_EXTRACTION_342F_DIR,
...
from datefac.benchmark.table_first_extraction_review_package_342g_report import (  # noqa: E402
    WORKBOOK_SHEETS,
    report_markdown,
    write_excel,
    write_json,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run 342G table-first extraction review package.")
    ...
    parser.add_argument("--core-extraction-342f-dir", default=str(DEFAULT_CORE_EXTRACTION_342F_DIR))
    ...
    artifacts = build_table_first_extraction_review_package_342g(
        ...
        core_extraction_342f_dir=Path(args.core_extraction_342f_dir),
    ...
    summary_json = output_dir / "table_first_extraction_review_package_342g_summary.json"
    manifest_json = output_dir / "table_first_extraction_review_package_342g_manifest.json"
    qa_json = output_dir / "table_first_extraction_review_package_342g_qa.json"
    no_write_back_json = output_dir / "table_first_extraction_review_package_342g_no_write_back_proof.json"
    report_md = output_dir / "table_first_extraction_review_package_342g_report.md"
    workbook_xlsx = output_dir / "table_first_extraction_review_package_342g.xlsx"
    ...
    print(f"table_first_extraction_review_package_342g_summary_json: {summary_json}")
    print(f"table_first_extraction_review_package_342g_manifest_json: {manifest_json}")
    print(f"table_first_extraction_review_package_342g_qa_json: {qa_json}")
    print(f"table_first_extraction_review_package_342g_no_write_back_proof_json: {no_write_back_json}")
    print(f"table_first_extraction_review_package_342g_report_md: {report_md}")
    print(f"table_first_extraction_review_package_342g_xlsx: {workbook_xlsx}")
    for key in [
        "audited_pdf_count",
