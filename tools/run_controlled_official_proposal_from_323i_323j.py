...
from datefac.semantic.controlled_official_proposal_from_323i import (  # noqa: E402
    EXPECTED_NEXT_DECISION,
    FORMAL_SCOPE_RULES_PATH,
    NOT_READY_DECISION,
    OFFICIAL_ALIAS_ASSET_PATH,
    build_controlled_official_proposal_from_323i,
    load_controlled_official_proposal_from_323i_inputs,
    _load_alias_reference,
    _load_scope_reference,
)
from datefac.semantic.controlled_official_proposal_from_323i_report import (  # noqa: E402
    controlled_official_proposal_from_323i_report_markdown,
    write_excel,
    write_json,
)
...
def _blocked_result(output_dir: Path, code: str) -> Dict[str, Any]:
    ...
    empty = pd.DataFrame()
    write_json(output_dir / "controlled_official_proposal_from_323i_323j_summary.json", summary)
    write_json(output_dir / "controlled_official_proposal_from_323i_323j_qa.json", qa_json)
    write_json(
        output_dir / "controlled_official_proposal_from_323i_323j_proposal_package.json",
        {
            "stage": "323J",
            "decision": NOT_READY_DECISION,
            ...
            "scope_proposals": [],
            "target_asset_plan": [],
            "duplicate_provenance_bridge": [],
        },
    )
    write_json(
        output_dir / "controlled_official_proposal_from_323i_323j_alias_proposals.json",
        {"alias_proposals": []},
    )
    write_json(
        output_dir / "controlled_official_proposal_from_323i_323j_scope_proposals.json",
        {"scope_proposals": []},
    )
    write_excel(
        output_dir / "controlled_official_proposal_from_323i_323j_proposals.xlsx",
        {
            ...
            "duplicate_provenance_bridge": empty,
    ...
    (
        output_dir / "controlled_official_proposal_from_323i_323j_review_notes.md"
    ).write_text(
        controlled_official_proposal_from_323i_report_markdown(summary),
        encoding="utf-8",
    )
    return summary
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run 323J controlled official proposal packaging from 323I."
    )
    parser.add_argument(
    ...
    if not official_rule_candidate_dir.exists():
        ...
        print(
            "controlled_official_proposal_from_323i_323j_summary_json: "
            f"{output_dir / 'controlled_official_proposal_from_323i_323j_summary.json'}"
        )
        return 0
    ...
    inputs = load_controlled_official_proposal_from_323i_inputs(
    ...
    artifacts = build_controlled_official_proposal_from_323i(
    ...
    excel_path = output_dir / "controlled_official_proposal_from_323i_323j_proposals.xlsx"
    summary_json_path = output_dir / "controlled_official_proposal_from_323i_323j_summary.json"
    qa_json_path = output_dir / "controlled_official_proposal_from_323i_323j_qa.json"
    package_json_path = output_dir / "controlled_official_proposal_from_323i_323j_proposal_package.json"
    alias_json_path = output_dir / "controlled_official_proposal_from_323i_323j_alias_proposals.json"
    scope_json_path = output_dir / "controlled_official_proposal_from_323i_323j_scope_proposals.json"
    notes_md_path = output_dir / "controlled_official_proposal_from_323i_323j_review_notes.md"
    ...
    sheets = {
        ...
        "duplicate_provenance_bridge": artifacts["duplicate_provenance_bridge_df"],
    ...
    print(f"controlled_official_proposal_from_323i_323j_excel: {excel_path}")
    print(f"controlled_official_proposal_from_323i_323j_summary_json: {summary_json_path}")
    print(f"controlled_official_proposal_from_323i_323j_qa_json: {qa_json_path}")
    print(f"controlled_official_proposal_from_323i_323j_package_json: {package_json_path}")
    print(f"controlled_official_proposal_from_323i_323j_alias_json: {alias_json_path}")
    print(f"controlled_official_proposal_from_323i_323j_scope_json: {scope_json_path}")
    print(f"controlled_official_proposal_from_323i_323j_review_notes_md: {notes_md_path}")
    for key in [
